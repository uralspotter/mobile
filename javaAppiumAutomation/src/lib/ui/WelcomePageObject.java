...
public class WelcomePageObject extends MainPageObject {
    ...
    private static final String
        ...
        STEP_NEW_WAYS_TO_EXPLORE_LINK = "New ways to explore",
        STEP_ADD_OR_EDIT_PREFERRD_LINK = "Add or edit preferred languages",
    ...
    public void waitForNewWayToExploreText() {
        this.waitForElementPresent(By.id(STEP_NEW_WAYS_TO_EXPLORE_LINK), "Cannot find 'New ways to explore' link", 10);
    }

    public void waitForAddOrEditPreferredText() {
        this.waitForElementPresent(By.id(STEP_ADD_OR_EDIT_PREFERRD_LINK), "Cannot find 'Add or edit preferred launguages' link", 10);
    }
    ...
    public void clickGetStartedButton() {
        this.waitForElementAndClick(By.id(GET_STARTED_LINK), "Cannot find and click 'Get started' button", 10);
    }
}
