...
public class MainPageObject {
    ...
    public WebElement waitForElementAndClear(String locator, String error_message) {
        return waitForElementAndClear(locator, error_message, 5);
    }

    public void checkSearch(WebElement input_title, String error_message, String expected_title) {
    ...
    public boolean isElementLocatedOnTheScreen(String locator) {
        ...
        int screen_by_size_y = driver.manage().window().getSize().getHeight();
        return element_location_by_y < screen_by_size_y;
    }
    ...
    public void tryClickElementWithFewAttempts(String locator, String erroe_message, int amount_of_attempts) {
        int current_attempts = 0;
        boolean need_more_attempts = true;

        while(need_more_attempts) {
            try {
                this.waitForElementAndClick(locator, erroe_message, 1);
                need_more_attempts = false;
            } catch (Exception e) {
                if(current_attempts > amount_of_attempts) {
                    this.waitForElementAndClick(locator, erroe_message);
                }
            }
            ++current_attempts;
        }
    ...
    public void clickElementToRightUpperCorner(String locator, String error_message) {
        if(driver instanceof AppiumDriver) {
            ...
            System.out.println("Method clickElementToRightUpperCorner() does nothing for platform " + Platform.getInstance().getPlatformVar());
        }
    }
}
