...
public class WelcomePageObject extends MainPageObject {
    ...
    private static final String
        ...
        STEP_ADD_OR_EDIT_PREFERRD_LINK = "id:Add or edit preferred languages",
    ...
    public void waitForAddOrEditPreferredText() {
        this.waitForElementPresent(STEP_ADD_OR_EDIT_PREFERRD_LINK, "Cannot find 'Add or edit preferred languages' link", 10);
    }
    ...
    public void clickGetStartedButton() {
        this.waitForElementAndClick(GET_STARTED_LINK, "Cannot find and click 'Get started' button", 10);
    }

    public void clickSkip() {
        this.waitForElementAndClick(SKIP,"Cannot find and click the skip button", 5);
    }
}
